...
Cálculo los máximos entre rgb de cada píxel, y los dejo en un xmm. Hago lo mismo con los mínimos, y los pongo en otro xmm. Cálculo la resta entre los máximos y los mínimos y los pongo en otro xmm. Obtendríamos lo siguiente:
...
\begin{enumerate}
	...
	Tomo el xmm resultado del cálculo de L, y lo copio en otro xmm. A esta copia la multiplico por dos en cada campo, y luego le resto uno a cada campo. Para calcular el fabs comparo por máximo a este xmm, y a otro xmm que sea el resultado de un xmm lleno de ceros restado verticalmente con el primer xmm. La idea de esto es que sea "e" un numero entero, entonces fabs(e) = "e" o "-e". Hasta ahora, me quedaría algo como:
